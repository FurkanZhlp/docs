...
## ✅ Enabling FabledSkyBlock Support

If FabledSkyBlock is installed, TimedWings will automatically detect.
...
```
[TimedWings - INFO] 🌍 [TimedWings - FabledSkyBlock Integration]
```
